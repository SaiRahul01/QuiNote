...
export const UserLoginReducer = (state = {},action) =>{
    switch(action.type)
    {
        ...
        case USER_LOGIN_SUCCESS:
            return {loading:true,quinoteuser:action.payload}
...
export const UserRegisterReducer = (state = {},action) =>{
    switch(action.type)
    {
        ...
        case USER_REGISTER_SUCCESS:
            return {loading:false,quinoteuser:action.payload}
...
export const UserUpdateReducer = (state = {},action) =>{
    switch(action.type)
    {
        ...
        case USER_UPDATE_SUCCESS:
            return {loading:false,quinoteuser:action.payload,success:true}
